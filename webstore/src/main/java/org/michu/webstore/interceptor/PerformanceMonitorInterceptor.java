package org.michu.webstore.interceptor;
...
public class PerformanceMonitorInterceptor implements HandlerInterceptor{
	//threadlocal variables can by read and written only by the same thread. For every thread new instance is created
	//Below is generic threadlocal varibale 
	//We use threadlocal because stopWatch is not thread-safe
